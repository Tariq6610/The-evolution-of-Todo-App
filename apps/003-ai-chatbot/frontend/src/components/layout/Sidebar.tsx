  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={`fixed top-0 left-0 h-full bg-white dark:bg-gray-900 shadow-xl z-50 flex flex-col transition-all duration-300 ${isCollapsed ? "w-20" : "w-64"} ${isMobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}
      >
        {/* Logo */}
